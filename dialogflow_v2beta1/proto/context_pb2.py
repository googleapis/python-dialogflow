...
_CONTEXTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\211\001\0226/v2beta1/{parent=projects/*/agent/sessions/*}/contextsZO\022M/v2beta1/{parent=projects/*/agent/environments/*/users/*/sessions/*}/contexts'),
  ),
  _descriptor.MethodDescriptor(
    name='GetContext',
    ...
    serialized_options=_b('\202\323\344\223\002\211\001\0226/v2beta1/{name=projects/*/agent/sessions/*/contexts/*}ZO\022M/v2beta1/{name=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateContext',
    ...
    output_type=_CONTEXT,
    serialized_options=_b('\202\323\344\223\002\233\001\"6/v2beta1/{parent=projects/*/agent/sessions/*}/contexts:\007contextZX\"M/v2beta1/{parent=projects/*/agent/environments/*/users/*/sessions/*}/contexts:\007context'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateContext',
    ...
    output_type=_CONTEXT,
    serialized_options=_b('\202\323\344\223\002\253\0012>/v2beta1/{context.name=projects/*/agent/sessions/*/contexts/*}:\007contextZ`2U/v2beta1/{context.name=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}:\007context'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteContext',
    ...
    serialized_options=_b('\202\323\344\223\002\211\001*6/v2beta1/{name=projects/*/agent/sessions/*/contexts/*}ZO*M/v2beta1/{name=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002\211\001*6/v2beta1/{parent=projects/*/agent/sessions/*}/contextsZO*M/v2beta1/{parent=projects/*/agent/environments/*/users/*/sessions/*}/contexts'),
  ),
])
