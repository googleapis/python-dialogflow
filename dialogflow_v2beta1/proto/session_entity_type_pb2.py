...
_LISTSESSIONENTITYTYPESREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            extension_scope=None,
            serialized_options=_b(
                "\340A\002\372A-\022+dialogflow.googleapis.com/SessionEntityType"
            ),
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
...
_SESSIONENTITYTYPES = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                "\202\323\344\223\002\270\002\0229/v2beta1/{name=projects/*/agent/sessions/*/entityTypes/*}ZR\022P/v2beta1/{name=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}ZG\022E/v2beta1/{name=projects/*/locations/*/agent/sessions/*/entityTypes/*}Z^\022\\/v2beta1/{name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}\332A\004name"
            ),
        ),
        _descriptor.MethodDescriptor(
