...
Intent = _reflection.GeneratedProtocolMessageType('Intent', (_message.Message,), dict(
  ...
  Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), dict(
    ...
    RbmText = _reflection.GeneratedProtocolMessageType('RbmText', (_message.Message,), dict(
    ...
    RbmCarouselCard = _reflection.GeneratedProtocolMessageType('RbmCarouselCard', (_message.Message,), dict(
    ...
    RbmStandaloneCard = _reflection.GeneratedProtocolMessageType('RbmStandaloneCard', (_message.Message,), dict(
    ...
    RbmCardContent = _reflection.GeneratedProtocolMessageType('RbmCardContent', (_message.Message,), dict(

      RbmMedia = _reflection.GeneratedProtocolMessageType('RbmMedia', (_message.Message,), dict(
    ...
    RbmSuggestion = _reflection.GeneratedProtocolMessageType('RbmSuggestion', (_message.Message,), dict(
    ...
    RbmSuggestedReply = _reflection.GeneratedProtocolMessageType('RbmSuggestedReply', (_message.Message,), dict(
    ...
    RbmSuggestedAction = _reflection.GeneratedProtocolMessageType('RbmSuggestedAction', (_message.Message,), dict(

      RbmSuggestedActionDial = _reflection.GeneratedProtocolMessageType('RbmSuggestedActionDial', (_message.Message,), dict(
      ...
      RbmSuggestedActionOpenUri = _reflection.GeneratedProtocolMessageType('RbmSuggestedActionOpenUri', (_message.Message,), dict(
      ...
      RbmSuggestedActionShareLocation = _reflection.GeneratedProtocolMessageType('RbmSuggestedActionShareLocation', (_message.Message,), dict(
    ...
    MediaContent = _reflection.GeneratedProtocolMessageType('MediaContent', (_message.Message,), dict(
      ...
      ResponseMediaObject = _reflection.GeneratedProtocolMessageType('ResponseMediaObject', (_message.Message,), dict(
    ...
    BrowseCarouselCard = _reflection.GeneratedProtocolMessageType('BrowseCarouselCard', (_message.Message,), dict(

      BrowseCarouselCardItem = _reflection.GeneratedProtocolMessageType('BrowseCarouselCardItem', (_message.Message,), dict(

        OpenUrlAction = _reflection.GeneratedProtocolMessageType('OpenUrlAction', (_message.Message,), dict(
    ...
    TableCard = _reflection.GeneratedProtocolMessageType('TableCard', (_message.Message,), dict(
    ...
    ColumnProperties = _reflection.GeneratedProtocolMessageType('ColumnProperties', (_message.Message,), dict(
    ...
    TableCardRow = _reflection.GeneratedProtocolMessageType('TableCardRow', (_message.Message,), dict(
    ...
    TableCardCell = _reflection.GeneratedProtocolMessageType('TableCardCell', (_message.Message,), dict(
...
_INTENTS = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  serialized_options=_b('\312A\031dialogflow.googleapis.com\322AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflow'),
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002f\022*/v2beta1/{parent=projects/*/agent}/intentsZ8\0226/v2beta1/{parent=projects/*/locations/*/agent}/intents'),
  ),
  _descriptor.MethodDescriptor(
    name='GetIntent',
    ...
    output_type=_INTENT,
    serialized_options=_b('\202\323\344\223\002f\022*/v2beta1/{name=projects/*/agent/intents/*}Z8\0226/v2beta1/{name=projects/*/locations/*/agent/intents/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateIntent',
    ...
    output_type=_INTENT,
    serialized_options=_b('\202\323\344\223\002v\"*/v2beta1/{parent=projects/*/agent}/intents:\006intentZ@\"6/v2beta1/{parent=projects/*/locations/*/agent}/intents:\006intent'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateIntent',
    ...
    output_type=_INTENT,
    serialized_options=_b('\202\323\344\223\002\204\00121/v2beta1/{intent.name=projects/*/agent/intents/*}:\006intentZG2=/v2beta1/{intent.name=projects/*/locations/*/agent/intents/*}:\006intent'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteIntent',
    ...
    serialized_options=_b('\202\323\344\223\002f**/v2beta1/{name=projects/*/agent/intents/*}Z8*6/v2beta1/{name=projects/*/locations/*/agent/intents/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\204\001\"6/v2beta1/{parent=projects/*/agent}/intents:batchUpdate:\001*ZG\"B/v2beta1/{parent=projects/*/locations/*/agent}/intents:batchUpdate:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002\204\001\"6/v2beta1/{parent=projects/*/agent}/intents:batchDelete:\001*ZG\"B/v2beta1/{parent=projects/*/locations/*/agent}/intents:batchDelete:\001*'),
  ),
])
