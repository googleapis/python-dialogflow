...
_LISTENVIRONMENTSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            extension_scope=None,
            serialized_options=_b(
                "\340A\002\372A'\022%dialogflow.googleapis.com/Environment"
            ),
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
...
_ENVIRONMENTS = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                "\202\323\344\223\002p\022//v2beta1/{parent=projects/*/agent}/environmentsZ=\022;/v2beta1/{parent=projects/*/locations/*/agent}/environments"
            ),
        )
    ],
)
