...
WebhookResponse = _reflection.GeneratedProtocolMessageType(
  ...
  v2.QueryResult.diagnostic_info] field. Setting JSON fields to an empty
  value with the wrong type is a common error. To avoid this error:  -
  Use ``""`` for empty strings -  Use ``{}`` or ``null`` for empty
  objects -  Use ``[]`` or ``null`` for empty arrays  For more
  ...
  Attributes:
      fulfillment_text:
          ...
          [QueryResult.fulfillment_text][google.cloud.dialogflow.v2.Quer
          yResult.fulfillment_text] sent to the integration or API
          caller.
      fulfillment_messages:
          Optional. The rich response messages intended for the end-
          user. When provided, Dialogflow uses this field to populate [Q
          ueryResult.fulfillment_messages][google.cloud.dialogflow.v2.Qu
          eryResult.fulfillment_messages] sent to the integration or API
          caller.
      source:
          ...
          e.cloud.dialogflow.v2.QueryResult.webhook_source] sent to the
      ...
      payload:
          ...
          ialogflow.v2.QueryResult.webhook_payload] sent to the
      ...
      output_contexts:
          ...
          .v2.QueryResult.output_contexts] sent to the integration or
          API caller.
      followup_event_input:
      ...
      session_entity_types:
          ...
          ionEntityType][google.cloud.dialogflow.v2.SessionEntityType]
          management methods.
  """,
