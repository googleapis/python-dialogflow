...
class TestDocumentsClient(object):
    ...
    def test_get_document(self):
        ...
        expected_response = {'name': name_2, 'display_name': display_name, 'mime_type': mime_type, 'content_uri': content_uri}
    ...
    def test_create_document(self):
        ...
        mime_type = 'mimeType-196041627'
        content_uri = 'contentUri-388807514'
        expected_response = {'name': name, 'display_name': display_name, 'mime_type': mime_type, 'content_uri': content_uri}
        expected_response = document_pb2.Document(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_create_document', done=True)
        ...
        assert len(channel.requests) == 1
        expected_request = document_pb2.CreateDocumentRequest(parent=parent, document=document)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_document_exception(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_create_document_exception', done=True)
    ...
    def test_delete_document(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_delete_document', done=True)
        operation.response.Pack(expected_response)
    ...
    def test_delete_document_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_delete_document_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_update_document(self):
        ...
        expected_response = {'name': name, 'display_name': display_name, 'mime_type': mime_type, 'content_uri': content_uri}
        expected_response = document_pb2.Document(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_update_document', done=True)
        operation.response.Pack(expected_response)
    ...
    def test_update_document_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_update_document_exception', done=True)
        operation.error.CopyFrom(error)
