...
class TestIntentsClient(object):
    ...
    def test_get_intent(self):
        ...
        expected_response = {'name': name_2, 'display_name': display_name, 'priority': priority, 'is_fallback': is_fallback, 'ml_enabled': ml_enabled, 'ml_disabled': ml_disabled, 'end_interaction': end_interaction, 'action': action, 'reset_contexts': reset_contexts, 'root_followup_intent_name': root_followup_intent_name, 'parent_followup_intent_name': parent_followup_intent_name}
    ...
    def test_create_intent(self):
        ...
        root_followup_intent_name = 'rootFollowupIntentName402253784'
        parent_followup_intent_name = 'parentFollowupIntentName-1131901680'
        expected_response = {'name': name, 'display_name': display_name, 'priority': priority, 'is_fallback': is_fallback, 'ml_enabled': ml_enabled, 'ml_disabled': ml_disabled, 'end_interaction': end_interaction, 'action': action, 'reset_contexts': reset_contexts, 'root_followup_intent_name': root_followup_intent_name, 'parent_followup_intent_name': parent_followup_intent_name}
        expected_response = intent_pb2.Intent(**expected_response)
