...
def test_create_entity_type(capsys):
    entity_type_ids = entity_type_service._get_entity_type_ids(ENTITY_TYPE_DISPLAY_NAME, PROJECT_ID)

    assert len(entity_type_ids) == 0

    entity_type = entity_type_service.create_entity_type(ENTITY_TYPE_DISPLAY_NAME, PROJECT_ID)
...
def test_create_entity(capsys):
    entity_type_id = entity_type_service._get_entity_type_ids(ENTITY_TYPE_DISPLAY_NAME, PROJECT_ID)[0]
    
    entity_service.create_entity(entity_type_id, ENTITY_VALUE_1, PROJECT_ID)
    entity_service.create_entity(entity_type_id, ENTITY_VALUE_2, PROJECT_ID, SYNONYMS)
...
def test_delete_entity(capsys):
    ...
    entity_service.delete_entity(entity_type_id, ENTITY_VALUE_1, PROJECT_ID)
    entity_service.delete_entity(entity_type_id, ENTITY_VALUE_2, PROJECT_ID)
...
def test_delete_entity_type(capsys):
    ...
    for entity_type_id in entity_type_ids:
        entity_type_service.delete_entity_type(entity_type_id, PROJECT_ID)
