...
""" DialogFlow ES: webhook to log session ID for each request."""

# [START dialogflow_webhook_log_session_id]
...
def log_session_id_for_troubleshooting(request):
    ...
    # You can read more about webhook request at
    # https://cloud.google.com/dialogflow/es/docs/reference/rest/v2beta1/WebhookRequest
...
# [END dialogflow_webhook_log_session_id]
