    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomParticipantsInterceptor(ParticipantsRestInterceptor):
            ...
            def pre_compile_suggestion(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_compile_suggestion(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            def pre_list_suggestions(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_suggestions(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_analyze_content(self, response: gcd_participant.AnalyzeContentResponse) -> gcd_participant.AnalyzeContentResponse:
        ...
        """
        return response
    def pre_compile_suggestion(self, request: participant.CompileSuggestionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.CompileSuggestionRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for compile_suggestion
    ...
    def post_compile_suggestion(self, response: participant.CompileSuggestionResponse) -> participant.CompileSuggestionResponse:
    ...
    def post_list_participants(self, response: participant.ListParticipantsResponse) -> participant.ListParticipantsResponse:
        ...
        """
        return response
    def pre_list_suggestions(self, request: participant.ListSuggestionsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[participant.ListSuggestionsRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for list_suggestions
    ...
    def post_list_suggestions(self, response: participant.ListSuggestionsResponse) -> participant.ListSuggestionsResponse:
            ...
            },
{
    ...
    class _CompileSuggestion(ParticipantsRestStub):
        def __hash__(self):
            return hash("CompileSuggestion")
        ...
        def __call__(self,
            ...
            r"""Call the compile suggestion method over HTTP.
            ...
            request, metadata = self._interceptor.pre_compile_suggestion(request, metadata)
            ...
            # Return the response
            resp = participant.CompileSuggestionResponse()
            pb_resp = participant.CompileSuggestionResponse.pb(resp)
            ...
            },
{
    ...
    class _ListSuggestions(ParticipantsRestStub):
        def __hash__(self):
            return hash("ListSuggestions")
        ...
        def __call__(self,
            ...
            r"""Call the list suggestions method over HTTP.
            ...
            request, metadata = self._interceptor.pre_list_suggestions(request, metadata)
            ...
            # Return the response
            resp = participant.ListSuggestionsResponse()
            pb_resp = participant.ListSuggestionsResponse.pb(resp)
            ...
            },
{
    ...
    def compile_suggestion(self) -> Callable[
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._CompileSuggestion(self._session, self._host, self._interceptor) # type: ignore
    ...
    def list_suggestions(self) -> Callable[
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._ListSuggestions(self._session, self._host, self._interceptor) # type: ignore
