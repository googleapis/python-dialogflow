...
class ConversationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_batch_create_messages(self, request: conversation.BatchCreateMessagesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[conversation.BatchCreateMessagesRequest, Sequence[Tuple[str, str]]]:
