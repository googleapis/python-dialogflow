...
class SessionEntityTypesAsyncClient:
    ...
    async def list_session_entity_types(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.ListSessionEntityTypesRequest, dict]]):
    ...
    async def get_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.GetSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def create_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.CreateSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def update_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.UpdateSessionEntityTypeRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_session_entity_type(self,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.DeleteSessionEntityTypeRequest, dict]]):
                The request object. The request message for
