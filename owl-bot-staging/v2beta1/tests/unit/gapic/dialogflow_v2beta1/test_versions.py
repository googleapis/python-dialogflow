...
from google.cloud.dialogflow_v2beta1.services.versions.transports.base import _API_CORE_VERSION
from google.cloud.dialogflow_v2beta1.services.versions.transports.base import _GOOGLE_AUTH_VERSION
