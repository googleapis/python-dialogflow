...
@pytest.mark.parametrize("client_class", [
    ConversationsClient, ConversationsAsyncClient
])
@mock.patch.object(ConversationsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConversationsClient))
@mock.patch.object(ConversationsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConversationsAsyncClient))
...
def test_suggest_conversation_summary(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.suggest_conversation_summary),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_stateless_summary(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_stateless_summary),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_knowledge(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_knowledge),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_conversation_rest(request_type):
    ...
    request_init["conversation"] = {'name': 'name_value', 'lifecycle_state': 1, 'conversation_profile': 'conversation_profile_value', 'phone_number': {'phone_number': 'phone_number_value'}, 'conversation_stage': 1, 'start_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}}
...
def test_create_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ConversationsRestInterceptor, "post_create_conversation") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_create_conversation") as pre:
...
def test_create_conversation_rest_bad_request(transport: str = 'rest', request_type=gcd_conversation.CreateConversationRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_list_conversations") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_list_conversations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversation.ListConversationsResponse.to_json(conversation.ListConversationsResponse())
...
def test_list_conversations_rest_bad_request(transport: str = 'rest', request_type=conversation.ListConversationsRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_get_conversation") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_get_conversation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_conversation_rest_bad_request(transport: str = 'rest', request_type=conversation.GetConversationRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_complete_conversation_rest_required_fields(request_type=conversation.CompleteConversationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).complete_conversation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_complete_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_complete_conversation") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_complete_conversation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.complete_conversation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_complete_conversation_rest_bad_request(transport: str = 'rest', request_type=conversation.CompleteConversationRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_messages_rest_required_fields(request_type=conversation.BatchCreateMessagesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_messages._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_batch_create_messages") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_batch_create_messages") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversation.BatchCreateMessagesResponse.to_json(conversation.BatchCreateMessagesResponse())
        ...
        client.batch_create_messages(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_create_messages_rest_bad_request(transport: str = 'rest', request_type=conversation.BatchCreateMessagesRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_list_messages") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_list_messages") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversation.ListMessagesResponse.to_json(conversation.ListMessagesResponse())
...
def test_list_messages_rest_bad_request(transport: str = 'rest', request_type=conversation.ListMessagesRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_suggest_conversation_summary_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = gcd_conversation.SuggestConversationSummaryResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_suggest_conversation_summary_rest_required_fields(request_type=gcd_conversation.SuggestConversationSummaryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suggest_conversation_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suggest_conversation_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_suggest_conversation_summary") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_suggest_conversation_summary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_conversation.SuggestConversationSummaryResponse.to_json(gcd_conversation.SuggestConversationSummaryResponse())
        ...
        client.suggest_conversation_summary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_suggest_conversation_summary_rest_bad_request(transport: str = 'rest', request_type=gcd_conversation.SuggestConversationSummaryRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_suggest_conversation_summary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{conversation=projects/*/conversations/*}/suggestions:suggestConversationSummary" % client.transport._host, args[1])
...
def test_generate_stateless_summary_rest_required_fields(request_type=conversation.GenerateStatelessSummaryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_stateless_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_stateless_summary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("statelessConversation", "conversationProfile", )))
...
def test_generate_stateless_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_generate_stateless_summary") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_generate_stateless_summary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversation.GenerateStatelessSummaryResponse.to_json(conversation.GenerateStatelessSummaryResponse())
        ...
        client.generate_stateless_summary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_generate_stateless_summary_rest_bad_request(transport: str = 'rest', request_type=conversation.GenerateStatelessSummaryRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_knowledge_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("query", "conversationProfile", )))
...
def test_search_knowledge_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationsRestInterceptor, "post_search_knowledge") as post, \
         mock.patch.object(transports.ConversationsRestInterceptor, "pre_search_knowledge") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = conversation.SearchKnowledgeResponse.to_json(conversation.SearchKnowledgeResponse())
        ...
        client.search_knowledge(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_knowledge_rest_bad_request(transport: str = 'rest', request_type=conversation.SearchKnowledgeRequest):
    client = ConversationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_conversations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.conversations.transports.ConversationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_conversations_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.conversations.transports.ConversationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConversationsTransport()
        adc.assert_called_once()
