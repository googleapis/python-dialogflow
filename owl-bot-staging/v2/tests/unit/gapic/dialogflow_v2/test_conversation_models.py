...
def test_conversation_model_path():
    ...
    expected = "projects/{project}/conversationModels/{conversation_model}".format(project=project, conversation_model=conversation_model, )
    actual = ConversationModelsClient.conversation_model_path(project, conversation_model)
    assert expected == actual
...
def test_conversation_model_evaluation_path():
    ...
    expected = "projects/{project}/conversationModels/{conversation_model}/evaluations/evaluation".format(project=project, conversation_model=conversation_model, )
