...
from google.cloud.dialogflow_v2.services.conversation_models import ConversationModelsAsyncClient
...
@pytest.mark.parametrize("client_class", [
    ConversationModelsClient, ConversationModelsAsyncClient
])
@mock.patch.object(ConversationModelsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConversationModelsClient))
@mock.patch.object(ConversationModelsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ConversationModelsAsyncClient))
...
def test_create_conversation_model(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_conversation_model),
            '__call__') as call:
...
def test_get_conversation_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_conversation_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = conversation_model.ConversationModel(
            ...
            article_suggestion_model_metadata=conversation_model.ArticleSuggestionModelMetadata(training_model_type=conversation_model.ConversationModel.ModelType.SMART_REPLY_DUAL_ENCODER_MODEL),
        )
...
def test_list_conversation_models_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, conversation_model.ConversationModel)
                   for i in results)
...
def test_delete_conversation_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_conversation_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_deploy_conversation_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.deploy_conversation_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_undeploy_conversation_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undeploy_conversation_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_conversation_model_evaluation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_conversation_model_evaluation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = conversation_model.ConversationModelEvaluation(
            ...
            smart_reply_metrics=conversation_model.SmartReplyMetrics(allowlist_coverage=0.19260000000000002),
        )
...
def test_list_conversation_model_evaluations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, conversation_model.ConversationModelEvaluation)
                   for i in results)
...
def test_create_conversation_model_evaluation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_conversation_model_evaluation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_create_conversation_model") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_create_conversation_model") as pre:
...
def test_get_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_get_conversation_model") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_get_conversation_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_conversation_models_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = conversation_model.ListConversationModelsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_conversation_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_list_conversation_models") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_list_conversation_models") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_delete_conversation_model") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_delete_conversation_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_deploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_deploy_conversation_model") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_deploy_conversation_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_undeploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_undeploy_conversation_model") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_undeploy_conversation_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_conversation_model_evaluation_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = conversation_model.ConversationModelEvaluation.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_get_conversation_model_evaluation") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_get_conversation_model_evaluation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_conversation_model_evaluations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = conversation_model.ListConversationModelEvaluationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_conversation_model_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_list_conversation_model_evaluations") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_list_conversation_model_evaluations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "post_create_conversation_model_evaluation") as post, \
         mock.patch.object(transports.ConversationModelsRestInterceptor, "pre_create_conversation_model_evaluation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ConversationModelsGrpcTransport, transports.ConversationModelsGrpcAsyncIOTransport])
def test_conversation_models_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
