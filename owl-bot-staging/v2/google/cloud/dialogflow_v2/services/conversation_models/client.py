...
class ConversationModelsClient(metaclass=ConversationModelsClientMeta):
    ...
    def conversation_model_path(project: str,conversation_model: str,) -> str:
        ...
        return "projects/{project}/conversationModels/{conversation_model}".format(project=project, conversation_model=conversation_model, )

    @staticmethod
    def parse_conversation_model_path(path: str) -> Dict[str,str]:
        """Parses a conversation_model path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/conversationModels/(?P<conversation_model>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def conversation_model_evaluation_path(project: str,conversation_model: str,) -> str:
        """Returns a fully-qualified conversation_model_evaluation string."""
        return "projects/{project}/conversationModels/{conversation_model}/evaluations/evaluation".format(project=project, conversation_model=conversation_model, )
    ...
    def parse_conversation_model_evaluation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/conversationModels/(?P<conversation_model>.+?)/evaluations/evaluation$", path)
        return m.groupdict() if m else {}
    ...
    def create_conversation_model(self,
            request: Union[gcd_conversation_model.CreateConversationModelRequest, dict] = None,
            *,
            parent: str = None,
    ...
    def undeploy_conversation_model(self,
            request: Union[conversation_model.UndeployConversationModelRequest, dict] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def get_conversation_model_evaluation(self,
            request: Union[conversation_model.GetConversationModelEvaluationRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    def list_conversation_model_evaluations(self,
            request: Union[conversation_model.ListConversationModelEvaluationsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    def create_conversation_model_evaluation(self,
            request: Union[conversation_model.CreateConversationModelEvaluationRequest, dict] = None,
            *,
            parent: str = None,
