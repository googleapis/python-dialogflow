...
class ConversationDatasetsClient(metaclass=ConversationDatasetsClientMeta):
    ...
    def create_conversation_dataset(self,
            request: Union[gcd_conversation_dataset.CreateConversationDatasetRequest, dict] = None,
            *,
            parent: str = None,
    ...
    def list_conversation_datasets(self,
            request: Union[conversation_dataset.ListConversationDatasetsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    def delete_conversation_dataset(self,
            request: Union[conversation_dataset.DeleteConversationDatasetRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
